...
## Solución
```
┌──(jhow㉿DESKTOP-Q5FQ7BC)-[/mnt/c/retospicoctf/Substitution1]
└─$ cat message.txt
...
```
Al usar [quipqiup - cryptoquip and cryptogram solver](https://quipqiup.com/) obtuvimos varias respuestas entre ellas la siguiente: 
```

...
## Solución
```
┌──(jhow㉿DESKTOP-Q5FQ7BC)-[/mnt/c/retospicoctf/keygenme-py]
...
```
Ahora solo realizamos un programa para encontrar la solución:
```
import hashlib
import base64
...
print(len(key))
```
Debemos de tomar en cuenta que hay que cambiar la variable username_trial por el que se nos da a cada uno de nosotros.
Ahora solo compilamos el programa:
```
┌──(jhow㉿DESKTOP-Q5FQ7BC)-[/mnt/c/retospicoctf/keygenme-py]
└─$ python3 sol.py

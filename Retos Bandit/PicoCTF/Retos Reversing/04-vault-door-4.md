...
## Solución
```
┌──(jhow㉿DESKTOP-Q5FQ7BC)-[/mnt/c/retospicoctf/VaultDoor4]
└─$ cat VaultDoor4.java
import java.util.*;
...
```
Una vez de haber visto esto metemos línea por línea el buffer de myBytes a un decodificador para saber cual es la bandera.
## Notas adicionales

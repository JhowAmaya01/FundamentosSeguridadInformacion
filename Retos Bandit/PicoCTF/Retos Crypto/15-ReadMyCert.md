...
┌──(jhow㉿DESKTOP-Q5FQ7BC)-[/mnt/c/retospicoctf/ReadMyCert]
└─$ file readmycert.csr
...
## Referencias
+ [How to Generate a CSR (Certificate Signing Request) in Linux? - GeeksforGeeks](https://www.geeksforgeeks.org/how-to-generate-a-csr-certificate-signing-request-in-linux/)